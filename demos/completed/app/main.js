define(["require", "exports", "tslib", "esri/intl", "esri/Map", "esri/views/MapView", "esri/layers/FeatureLayer", "./LayerFXCalcite"], function (require, exports, tslib_1, intl_1, Map_1, MapView_1, FeatureLayer_1, LayerFXCalcite_1) {
    "use strict";
    ...
    LayerFXCalcite_1 = tslib_1.__importDefault(LayerFXCalcite_1);
    ...
    var layerFX = new LayerFXCalcite_1.default({ layer: layer });
